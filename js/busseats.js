...
//           if (selectedSeats.length < maxSeatLimit && selectedSeats.length >= minSeatLimit) {
...
//             updateTotalPrice();
//           } else if (selectedSeats.length < minSeatLimit) {
//             alert("Please select at least 2 seats");
//           } else {
//             alert("You have reached the maximum seat limit of 5");
//           }
//         }
//       });
//     });
